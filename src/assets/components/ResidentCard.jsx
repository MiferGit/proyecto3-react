...
const statusIcon = status === 'alive' ? '🏷️' : status === 'dead' ? '🔖' : '🦴'
    ...
    <div className="card">
        ...
        <div className="card__info">
            <span className="card__info-item">
                <span className="card__info-span">Species:   </span>
                {resident?.species}
            </span>
            <span className="card__info-item">
                <span className="card__info-span">Origin:   </span>
                {resident?.origin?.name}
            </span>
            <span className="card__info-item">
                <span className="card__info-span">Gender:   </span>
                {resident?.gender}
            </span>
            <span className="card__info-item">
                <span className="card__info-span">Episode where they appear:  </span>
